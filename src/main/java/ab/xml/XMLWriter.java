 ...
 *
 * <p>Differences with StAX, the Streaming API for XML: <ul>
 *
 * <li>Empty tags must be closed with {@link #endTag}.</li>
 *
 * <li>Elements that are empty may automatically be written as empty tags, even
 * when started with {@link #startTag}.</li>
 *
 * <li>Binding a namespace prefix using {@link #setPrefix} applies to the next
 * element that is written, not the current element.</li>
 *
 ...
 * </ul>
 *
 * <p>Differences with XML Pull: <ul>
 *
 * <li>To ensure that an empty tag is written, use {@link #emptyTag} instead of
 * {@link #startTag}. The latter may result in a separate end tag.</li>
 *
 * </ul>
 *
 * @author G. Meinders
...
public interface XMLWriter
{
	 ...
	 * empty tag if nothing is written inside the tag. To ensure an empty tag is
	 * written, use {@link #emptyTag}.
	 *
